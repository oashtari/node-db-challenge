  ...
  return knex('tasks').del()
    .then(function () {
      ...
      return knex('tasks').insert([
        ...
        { id: 2, project_id: 1, task_description: 'dump the shelves', notes: 'walk yo behind to garbage bin', completed: false },
        ...
        { id: 5, project_id: 2, task_description: 'be good to environment', notes: 'keep good nails, dump other nails in recycling', completed: false },
